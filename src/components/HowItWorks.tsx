...
const steps = [
  ...
  },
  {
    ...
    number: "02",
    title: "Claim & Deploy",
    description: "One click to claim. You get the full React + TypeScript source, Netlify/Vercel deploy configs, and an auto-generated README. Deploy in minutes.",
    gradient: "from-accent to-secondary",
  },
  {
    icon: HeartHandshake,
    number: "03",
    title: "Message the Builder",
    description: "Every claim opens a direct line to the builder. Ask questions, request tweaks, or discuss custom forks — real humans, not bots.",
